...
<?php session_start();?>
  <head>
    ...
    <title>Kitwe Hospital Blood Bank</title>
...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="deals.html">Testmonies</a></li>
        ...
        <div id="top-banner-1" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              ...
              <h1>Our Partners</h1>
              <div class="border-button"><a href="about.html">Visit</a></div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2022 <a href="#">WhiteHorse</a> Company. All rights reserved. 
          <br>Design: <a href="https://templatemo.com" target="_blank" title="free CSS templates">Joseph</a></p>
        </div>
      </div>
    </div>
  </footer>
